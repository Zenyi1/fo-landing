    ...
    endpoints: [
      {
        ...
        examples: [
          '/api/regulation/solve?assetId=onc-biologic&targets=US,EU,JP,UK,CA,AU,SG,BR,SA',
          '/api/regulation/solve?assetId=hiv-small-molecule&targets=KE,UG,TZ,RW,ZA,NG,PH&budget=400000',
          '/api/regulation/solve?indication=oncology&kind=biologic&priorityReviewGrade=true&targets=US,EU,AU',
        ],
      },
      {
        path: '/api/regulation/markets',
        methods: ['GET'],
      ...
      { path: '/api/regulation/programs', methods: ['GET'], description: 'Multilateral schemes: Orbis, Access Consortium, EU-M4all, WHO PQ and CRP, MAGHP, ZaZiBoNa, MDSAP.' },
      { path: '/api/regulation/authorities', methods: ['GET'], description: 'Reference authorities with ICH membership and WHO-Listed Authority scopes.' },
      { path: '/api/regulation/assets', methods: ['GET'], description: 'Asset archetypes, each with the routes and programs it can actually reach.' },
      { path: '/api/regulation/health', methods: ['GET'], description: 'Knowledge-base counts and seed-time validation status.' },
    ],
    notes: [
