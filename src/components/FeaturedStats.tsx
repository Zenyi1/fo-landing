...
export function FeaturedStats() {
  return (
    <section id="stats" className="relative overflow-hidden bg-white text-brand py-24 md:py-40">
      <FlowFieldBackground />
      <div className="relative z-10 max-w-[1280px] mx-auto px-6 md:px-10">
        ...
        <div className="mt-24 md:mt-40 space-y-16 md:space-y-24">
          {STATS.map((stat) => (
            <SlideIn key={stat.label} from={stat.align}>
              ...
              >
                <div className="font-serif leading-[0.9] text-brand text-[72px] md:text-[120px] lg:text-[165px]">
                  {stat.value}
                </div>
                <div className="mt-4 md:mt-6 text-[12px] md:text-sm tracking-[0.15em] uppercase text-brand">
                  {stat.label}
                </div>
              </div>
            </SlideIn>
        ...
        <a
          ...
          className="inline-flex items-center gap-3 mt-16 md:mt-24 text-base md:text-lg text-brand hover:opacity-70 transition-opacity"
        >
