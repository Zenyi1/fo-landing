...
import type { EnrichedPoint } from '@/lib/regulation/api/enrich'
...
export function Router({
  ...
  async function interpret() {
    ...
    try {
      const res = await fetch(`/api/regulation/intake?drug=${encodeURIComponent(description)}`)
  ...
  async function solve() {
    ...
    setError(null)
    try {
      const res = await fetch('/api/regulation/solve', {
        method: 'POST',
