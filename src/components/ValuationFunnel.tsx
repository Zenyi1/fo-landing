      ...
      {stage === "form" && (
        <div className="mx-auto w-full max-w-[560px]">
          ...
          <p className="mt-3 text-[15px] leading-[1.55] text-ink md:text-[16px]">
            ...
            language-model estimate, not a valuation. Do not use it for a board
            paper.
          </p>
...
function ResultView({
  ...
  return (
    <div className="mx-auto flex w-full max-w-[640px] flex-col items-center text-center">
      <p className="text-[15px] font-medium text-brand">Directional estimate</p>
      ...
      <p className="mt-5 max-w-[44ch] text-[14px] leading-[1.6] text-ink">
        A 30-minute call. Which markets drive the number, and which registration
        route each one allows.
      </p>
      ...
      <p className="mt-10 max-w-[52ch] text-[13px] leading-[1.6] text-ink/70">
        ...
        Excludes China. Generated by a language model.
      </p>
    </div>
  );
}
