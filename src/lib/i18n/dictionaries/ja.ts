...
export const ja: Dictionary = {
  ...
  home: {
    ...
    metaDescription:
      "First Oceanは、投資家の皆様に質の高いリターンを提供することを使命とする、グローバルで多様化されたオルタナティブ投資企業です。",
  ...
  approach: {
    metaTitle: "アプローチ",
    metaDescription:
      "First OceanのAIソーシングエンジンは、リスクが低減された承認済み治療薬を患者層、規制経路、商業的適合性に照らして評価し、最適なアセットをLATAM・MENA・SEAへ届けます。",
    kicker: "/アプローチ",
    ...
    gapClose: "First Oceanは、このギャップを埋めるために存在します。",
  ...
  contact: {
    metaTitle: "お問い合わせ",
    metaDescription:
      "First Oceanにご連絡ください。パートナーシップ、投資、採用、メディアのお問い合わせを承ります。",
    kicker: "/お問い合わせ",
    headline: "お問い合わせ",
