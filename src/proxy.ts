...
// Europe, North America and Japan get the intelligence page as the homepage;
// everyone else keeps the licensing homepage. Rewrite rather than redirect, so
// the URL stays "/" and /intelligence remains directly reachable from anywhere.
//
// Geographic Europe, including the non-EU east and the crown dependencies, plus
// the US, Canada, Mexico and Japan. Turkey and the Caucasus are left out: they sit
